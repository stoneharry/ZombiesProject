...
CHAR_LOGIN_LOCKED_BY_BILLING = "Your character has died and is out of life's.";
...
LOGIN = "Login";
LOGIN_ACCOUNT_CONVERTED = "This account is now registered. Please login with your new username and and password.";
...
LOGIN_IGR_WITHOUT_BNET = "<html><body><p align=\"CENTER\">This username is already taken! Try again with a different username.</p></body></html>";
